...
export const Login: React.FC = () => { // Nome alterado para Login
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      // Redirecionando para /home conforme definido anteriormente
    ...
    <div className="w-screen h-screen flex flex-col items-center justify-center bg-[#f8f9fa] font-sans p-4">
      ...
      <div className="w-full max-w-md bg-white border border-[#dee2e6] rounded-md shadow-lg p-12 flex flex-col gap-8">
        ...
        <div className="text-center flex flex-col items-center gap-3">
          ...
          <h1 className="text-xl font-bold text-gray-800 tracking-tight mt-1">Tecnologia da Informação</h1>
        </div>
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              placeholder="Usuário ou email@engebag.com.br"
